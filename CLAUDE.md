...
**וידאו/תמונות:** הווידאו בסקשן ה-Split הוא צילום אמיתי של הסטודיו, מתארח מקומית ב-`media/studio.mp4`
(הוחלף ביולי 2026, הוגדר ב-`script.js` בקבוע `STUDIO_VIDEO`). תמונת ה-Hero עדיין placeholder מ-`media.base44.com`.
...
- תמונת ה-Hero עדיין מתארחת על `media.base44.com` (hotlink) — עדיף להעלות עצמאית כדי לא להיות תלויים בשירות חיצוני

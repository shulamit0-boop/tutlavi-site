...
**מיילים:** אין שירות מייל מחובר לאתר. הבקשה עצמה נשלחת ב-FormSubmit (כמו קודם),
אבל **הקישור לחתימה נשלח ידנית**: כפתור "אישור ושליחת חוזה" בפאנל פותח מייל מוכן
(`mailto:`) עם הנוסח והקישור. אם ירצו אוטומציה מלאה — צריך לחבר שירות (Resend וכו').
